...
ASSERT_ACTION(GHOSTTY_MOUSE_HIDDEN, 1);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_DEFAULT, 0);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_CONTEXT_MENU, 1);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_HELP, 2);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_POINTER, 3);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_PROGRESS, 4);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_WAIT, 5);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_CELL, 6);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_CROSSHAIR, 7);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_TEXT, 8);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_VERTICAL_TEXT, 9);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_ALIAS, 10);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_COPY, 11);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_MOVE, 12);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_NO_DROP, 13);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_NOT_ALLOWED, 14);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_GRAB, 15);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_GRABBING, 16);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_ALL_SCROLL, 17);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_COL_RESIZE, 18);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_ROW_RESIZE, 19);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_N_RESIZE, 20);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_E_RESIZE, 21);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_S_RESIZE, 22);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_W_RESIZE, 23);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_NE_RESIZE, 24);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_NW_RESIZE, 25);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_SE_RESIZE, 26);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_SW_RESIZE, 27);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_EW_RESIZE, 28);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_NS_RESIZE, 29);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_NESW_RESIZE, 30);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_NWSE_RESIZE, 31);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_ZOOM_IN, 32);
ASSERT_ACTION(GHOSTTY_MOUSE_SHAPE_ZOOM_OUT, 33);

#undef ASSERT_ACTION

_Static_assert(sizeof(((ghostty_action_u *)0)->mouse_shape) == sizeof(int),
               "ghostty mouse-shape payload changed layout");
